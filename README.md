...
![image](https://github.com/user-attachments/assets/d8e75c94-e354-4116-86fa-c22f9ed7855a)
...
## FAQ
**1**: How does this project differ from the original Nekoray?
...
**2**: Why does my Anti-Virus detect Nekoray and/or its Core as malware?
...
**3**: Is setting the `SUID` bit really needed on Linux?
...
**4**: Can the AUR, PKGCONFIG etc be published so that Linux users can install the app using their own ways?
